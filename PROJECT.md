...
- Die ausdrücklich freigegebene automatische Aktivierung im SERVICEWORKER-002-Worker war eine einmalige Legacy-Brücke für ältere Clients ohne Update-UI. Sie verwendet weder `clients.claim()` noch einen automatischen Reload. Die reale Übergangsabnahme mit 0.10.9 ist bestätigt; deshalb muss die Brücke vor dem unmittelbar folgenden Worker/Release entfernt werden. Der automatisierte Release-Preflight blockiert einen weiteren Release-Kandidaten, solange die Legacy-Konstante noch aktiv ist.
