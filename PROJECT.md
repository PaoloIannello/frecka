...
- Die ausdrücklich freigegebene automatische Aktivierung im SERVICEWORKER-002-Worker ist eine einmalige Legacy-Brücke für ältere Clients ohne Update-UI. Sie verwendet weder `clients.claim()` noch einen automatischen Reload. Da der reale Übergang der bereits ausgelieferten Altclients noch nicht bestätigt ist, bleibt sie in 0.10.9 fachlich unverändert erhalten; nach bestätigter Übergangsabnahme muss sie im unmittelbar folgenden Worker/Release entfernt werden.
