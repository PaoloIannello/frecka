...
MULTI-COMPANY-002 ist ein nachgelagerter, noch nicht veröffentlichter Architekturblock. Er hebt das lokale Datenbankschema kontrolliert von 8 auf 9 an und macht `companies[]` zur kanonischen Unternehmensstruktur. Bestehende Installationen und frische Mandanten besitzen weiterhin genau ein sichtbares und nutzbares Profil. Geschäftsbereiche, Leistungsorte, Belege, Gutscheine, Rezepte und Behandlungsdatensätze tragen eine direkte, hart validierte `companyId`; Kunden, V1-Benutzer, Logo-Asset-Register und Geräteruntime bleiben installationsweit gemeinsam. Historische Snapshots, Nummern, Zeitpunkte und Steuerwerte werden durch die Migration nicht neu erzeugt oder verändert. Mehr-Unternehmens-UI, Profilwechsel, neue Nummernkreise und mehrere Lizenzbindings folgen nicht aus diesem Block.
