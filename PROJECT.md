...
Aktueller Entwicklungszusatz PODOLOGY-001/002 auf Basis von v0.11.6: `features.prescriptionDocumentation` ist pro Geschäftsbereich optional und standardmäßig aus. Rezepte sind ein eigener mandantenbezogener Bestand (`prescriptions`, Schema 7), nicht Teil von Kundenobjekten. Ein normaler Beleg kann beim Abschluss optional einen unveränderlichen Rezept-Snapshot aufnehmen. Der Verbrauch wird ausschließlich aus diesen abgeschlossenen Belegen abgeleitet; es gibt weder gespeicherte Restwerte noch eine zweite Nutzungsliste. Ein vollständiger Storno neutralisiert genau den referenzierten Ursprungsbeleg, Gutschriften bleiben verbrauchsneutral. Snapshot, verschlüsseltes Backup, Restore und Integritätsprüfung umfassen sechs Fachstores; `licenseRuntime` bleibt getrennt. Rezeptdaten und Belegzuordnungen bleiben aus regulären Exporten, Dokumenten, PDF, QR, Public Viewer und Diagnoseausgaben ausgeschlossen. Es gibt noch keine Behandlungsakte. Verbindliche Details: [Rezeptverwaltung](docs/prescriptions.md).
