...
MULTI-COMPANY-002/003 sind nachgelagerte, noch nicht veröffentlichte Architekturblöcke. Schema 9 macht `companies[]` zur kanonischen Unternehmensstruktur; MULTI-COMPANY-003 ergänzt darin versionierte, profil- und jahresbezogene Nummernkontexte für Normalbeleg, Storno und Gutschrift. Bestehende Installationen und frische Mandanten besitzen weiterhin genau ein sichtbares und nutzbares Profil. Geschäftsbereiche, Leistungsorte, Belege, Gutscheine, Rezepte und Behandlungsdatensätze tragen eine direkte, hart validierte `companyId`; Kunden, V1-Benutzer, Logo-Asset-Register und Geräteruntime bleiben installationsweit gemeinsam. Historische Snapshots, Nummern, Zeitpunkte und Steuerwerte werden nicht neu erzeugt oder verändert. Mehr-Unternehmens-UI, Profilwechsel und mehrere Lizenzbindings folgen daraus nicht.
