...
LICENSE-005 ergänzt die getrennte lokale Lizenzruntime: `settings.license` Version 2 bleibt portable und nicht autoritativ, während Geräte-ID, nicht exportierbarer P-256-Privatkey, exportierbarer Public Key, Thumbprint und optionale Token-/Zeitmetadaten ausschließlich im neuen IndexedDB-Store `licenseRuntime` liegen. Das Schema steigt von 5 auf 6; Tenant-Snapshot, Backup, Restore, Diagnose und beide Exportarten bleiben auf die fünf Geschäftsstores begrenzt. Der strikte ES256/JWS-Prüfpfad enthält keinen eingebauten Serverprüfschlüssel und erzeugt daher weder Trial-/Active-Status noch Produktsperre. LICENSE-006 bleibt bis zur realen CryptoKey-Persistenzprüfung auf iPhone/Home-Screen-PWA und Android gesperrt.
