...
const baseUrl = "https://beta.frecka.app/releases/0.11.4-test/site/";
...
assert.equal(new URL(manifest.start_url, baseUrl).pathname, "/releases/0.11.4-test/site/index.html");
assert.equal(new URL(manifest.scope, baseUrl).pathname, "/releases/0.11.4-test/site/");
...
const currentCache = [...cacheNames].find(name => name === "frecka-app-shell-0.11.4-backup006-1");
...
const cachedAsset = { source: "cache", url: `${baseUrl}styles.css?v=backup006-1` };
