...
const baseUrl = "https://beta.frecka.app/releases/0.11.3-test/site/";
...
assert.ok(addedUrls.includes(`${baseUrl}styles.css?v=backup005-1`));
assert.ok(addedUrls.includes(`${baseUrl}vendor/jszip-v3.10.1.min.js?v=backup005-1`));
assert.ok(addedUrls.includes(`${baseUrl}js/export-package.js?v=backup005-1`));
assert.ok(addedUrls.includes(`${baseUrl}js/pwa-update.js?v=backup005-1`));
assert.ok(addedUrls.includes(`${baseUrl}js/app.js?v=backup005-1`));
...
assert.equal(new URL(manifest.start_url, baseUrl).pathname, "/releases/0.11.3-test/site/index.html");
assert.equal(new URL(manifest.scope, baseUrl).pathname, "/releases/0.11.3-test/site/");
...
const currentCache = [...cacheNames].find(name => name === "frecka-app-shell-0.11.3-backup005-1");
...
const cachedAsset = { source: "cache", url: `${baseUrl}styles.css?v=backup005-1` };
