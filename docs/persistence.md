...
**Stand:** MULTI-COMPANY-003 auf Basis MULTI-COMPANY-002, PODOLOGY-006, LICENSE-005, TSE-002, SETTINGS-002, USER-002, PERSISTENCE-007, BACKUP-001 und EXPORT-003
**Geltungsbereich:** Kanonische Unternehmensprofile mit weiterhin nur einem sichtbaren Produktprofil, profilbezogene Belegnummernkreise, vollständige FRECKA-Einstellungen, lokaler Benutzer und portable Lizenzreferenz, gerätelokale Lizenzruntime, Katalog, gemeinsame Kundenstammdaten, abgeschlossene Belege, offene Zahlungen, Stornos, Gutschriften, Gutscheine, Rezepte und Behandlungsdokumentation
...
- `data.license`: genau eine portable, nicht autoritative Lizenzreferenz der Formatversion 2; Gerätebindung und Schlüssel gehören ausschließlich in `licenseRuntime`;
...
- `companies` mit mindestens einem vollständig referenzierten Profil aus `id`, `formatVersion`, `company`, `taxSettings`, `receiptSettings`, `paymentChoices`, `tseSettings`, portabler `license`-Referenz und `setup` sowie eine passende `activeCompanyId`; die Produktoberfläche legt weiterhin nur Profil 1 an und bietet keinen Wechsel an;
