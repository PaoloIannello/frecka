...
Geltungsbereich: vorbereiteter Stand `0.10.7`, Build `PERSISTENCE-010`; noch kein Release-Tag oder Artefakt für 0.10.7
...
Ein Release-Identifier muss eindeutig und dateisystemfreundlich sein. Verbindlich ist das Schema `<version>-<kurzer-git-commit>`, beispielsweise `0.10.7-1a2b3c4`. Die konkrete ID des vorbereiteten Kandidaten darf erst nach dem Release-Commit gebildet werden.
