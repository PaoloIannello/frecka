...
Geltungsbereich: vorbereiteter Stand `0.10.5`, Build `BACKUP-002`; noch kein Release-Tag oder Artefakt für 0.10.5
...
Ein Release-Identifier muss eindeutig und dateisystemfreundlich sein. Verbindlich ist das Schema `<version>-<kurzer-git-commit>`, beispielsweise `0.10.5-1a2b3c4`. Die konkrete ID des vorbereiteten Kandidaten darf erst nach dem Release-Commit gebildet werden.
