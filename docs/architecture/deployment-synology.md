...
Geltungsbereich: vorbereiteter Stand `0.10.6`, Build `PERSISTENCE-008`; noch kein Release-Tag oder Artefakt für 0.10.6
...
Ein Release-Identifier muss eindeutig und dateisystemfreundlich sein. Verbindlich ist das Schema `<version>-<kurzer-git-commit>`, beispielsweise `0.10.6-1a2b3c4`. Die konkrete ID des vorbereiteten Kandidaten darf erst nach dem Release-Commit gebildet werden.
