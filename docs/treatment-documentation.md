...
Stand: 02.09.2026. PODOLOGY-003 ergänzt auf Basis von v0.11.6 die beleggebundene Behandlungsdokumentation. PODOLOGY-004 projiziert daraus genau den Kundenpflegehinweis und aus dem unveränderlichen Rezeptzuordnungs-Snapshot genau das Rezeptdatum in lokale Kundendokumente. Version 0.11.8 / PODOLOGY-005 poliert ausschließlich Vorlagenauswahl, Hilfetexte und Vorlagenkarten. Der für 0.11.9 vorbereitete Block PODOLOGY-006 verdichtet ausschließlich den internen Kundenverlauf; Datenmodell und Ausgabevertrag bleiben unverändert. Die separaten Versions-/Cacheanpassungen sind im [Release-Freigabenachweis](releases/0.11.9.md) dokumentiert.
...
PODOLOGY-006 wird als separater Patch 0.11.9 vorbereitet und nicht in das bestehende Release 0.11.8 nachgetragen. Die technische Freigabe für den automatisierten Beta-Release ist kein Geräte-GO. Nach dem späteren Upload und der manuellen Web-Station-Umschaltung bleibt die reale iPhone-/Android-Sichtprüfung einschließlich Touchbedienung und VoiceOver/TalkBack offen. Der In-place-Test benötigt eine vorherige verschlüsselte Sicherung; Offline-Kaltstart, Datenbestand, Belegansicht, PDF, Teilen/Speichern und die fortbestehende Public-/Steuerberater-Isolation bleiben manuelle Gerätegates vor weiterer Freigabe.
